...
class DolatProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        self.BASE_URL = "https://api.dolatcapital.com"
        self.logger = logging.getLogger("DolatProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("dolat: BASE_URL=%s — not verified from live trace", self.BASE_URL)
