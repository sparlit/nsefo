...
class YesSecuritiesProvider(Broker):
    DEPRECATED = False
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "yes_securities"
        self.provider = "yes_securities"
        ...
        self.BASE_URL = "https://www.yessecurities.co.in"
        self.logger = logging.getLogger("YesSecuritiesProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("yes_securities: BASE_URL=%s — not verified from live trace", self.BASE_URL)
