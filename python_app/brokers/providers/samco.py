...
class SamcoProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        self.BASE_URL = "https://www.samco.in"
        self.logger = logging.getLogger("SamcoProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("samco: BASE_URL=%s — not verified from live trace", self.BASE_URL)
