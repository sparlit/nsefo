...
class SwastikaProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "swastika"
        self.provider = "swastika"
        ...
        self.BASE_URL = "https://invest.swastika.co.in"
        self.logger = logging.getLogger("SwastikaProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("swastika: BASE_URL=%s — not verified from live trace", self.BASE_URL)
