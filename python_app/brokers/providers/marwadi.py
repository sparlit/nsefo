...
class MarwadiProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "marwadi"
        self.provider = "marwadi"
        ...
        self.BASE_URL = "https://www.marwadionline.com"
        self.logger = logging.getLogger("MarwadiProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("marwadi: BASE_URL=%s — not verified from live trace", self.BASE_URL)
