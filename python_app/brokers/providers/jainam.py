...
class JainamProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "jainam"
        self.provider = "jainam"
        ...
        self.BASE_URL = "https://www.jainam.org"
        self.logger = logging.getLogger("JainamProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("jainam: BASE_URL=%s — not verified from live trace", self.BASE_URL)
