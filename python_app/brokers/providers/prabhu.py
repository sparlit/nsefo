...
class PrabhuProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "prabhu"
        self.provider = "prabhu"
        ...
        self.BASE_URL = "https://www.prabhuwealth.com"
        self.logger = logging.getLogger("PrabhuProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("prabhu: BASE_URL=%s — not verified from live trace", self.BASE_URL)
