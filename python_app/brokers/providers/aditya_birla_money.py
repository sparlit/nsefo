"""AdityaBirlaMoney provider stub."""
...
class AdityaBirlaMoneyProvider(Broker):
    DEPRECATED = False
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "aditya_birla_money"
        self.provider = "aditya_birla_money"
        ...
        self.BASE_URL = "https://www.adityabirlamoney.com"
        self.logger = logging.getLogger("AdityaBirlaMoneyProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("aditya_birla_money: BASE_URL=%s — not verified from live trace", self.BASE_URL)
