...
class CLSAProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        self.BASE_URL = "https://www.clsa.com"
        self.logger = logging.getLogger("CLSAProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("clsa: BASE_URL=%s — not verified from live trace", self.BASE_URL)
