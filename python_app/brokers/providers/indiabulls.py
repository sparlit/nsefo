...
class IndiabullsProvider(Broker):
    DEPRECATED = False
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "indiabulls"
        self.provider = "indiabulls"
        ...
        self.BASE_URL = "https://www.indiabulls.com"
        self.logger = logging.getLogger("IndiabullsProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("indiabulls: BASE_URL=%s — not verified from live trace", self.BASE_URL)
