...
class VenturaProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "ventura"
        self.provider = "ventura"
        ...
        self.BASE_URL = "https://www.ventura1.com"
        self.logger = logging.getLogger("VenturaProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("ventura: BASE_URL=%s — not verified from live trace", self.BASE_URL)
