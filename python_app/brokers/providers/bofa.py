...
class BofaProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        self.BASE_URL = "https://www.bofasom.com"
        self.logger = logging.getLogger("BofaProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("bofa: BASE_URL=%s — not verified from live trace", self.BASE_URL)
