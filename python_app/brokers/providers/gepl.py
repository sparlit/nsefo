...
class GEPLProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        self.BASE_URL = "https://www.geplonline.com"
        self.logger = logging.getLogger("GEPLProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("gepl: BASE_URL=%s — not verified from live trace", self.BASE_URL)
