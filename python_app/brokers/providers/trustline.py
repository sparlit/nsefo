...
class TrustlineProvider(Broker):
    DEPRECATED = False
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "trustline"
        self.provider = "trustline"
        ...
        self.BASE_URL = "https://trade.trustline.in"
        self.logger = logging.getLogger("TrustlineProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("trustline: BASE_URL=%s — not verified from live trace", self.BASE_URL)
