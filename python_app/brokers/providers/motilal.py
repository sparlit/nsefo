# Migrated from python_app/broker/motilal.py — DO NOT EDIT HERE
"""
Motilal Oswal Broker Implementation (MOInvestor API)
API Docs: https://api.motilaloswal.com
Authentication: client_id + api_key + password/PAN
"""
...
class MotilalProvider(Broker):
    def __init__(self, client_id: str, access_token: str, **kwargs):
        ...
        self.logger = logging.getLogger("MotilalProvider")
    ...
    def login(self, **kwargs) -> bool:
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                return True
            self.logger.warning(f"Motilal login failed: {resp.status_code}")
            return False
        except Exception as e:
            self.logger.error(f"Motilal Login Error: {e}")
            return False
    ...
    def start_data_feed(self, symbols: List[Dict[str, Any]],
        ...
        ws_url = "wss://streaming.motilaloswal.com/stream"
