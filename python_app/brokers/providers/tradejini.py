...
class TradejiniProvider(Broker):
    DEPRECATED = False
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "tradejini"
        self.provider = "tradejini"
        ...
        self.BASE_URL = "https://www.tradejini.com"
        self.logger = logging.getLogger("TradejiniProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("tradejini: BASE_URL=%s — not verified from live trace", self.BASE_URL)
