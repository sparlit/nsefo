...
class InvestecProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "investec"
        self.provider = "investec"
        ...
        self.BASE_URL = "https://www.investec.com"
        self.logger = logging.getLogger("InvestecProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("investec: BASE_URL=%s — not verified from live trace", self.BASE_URL)
