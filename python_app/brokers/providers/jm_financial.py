...
class JMFinancialProvider(Broker):
    DEPRECATED = False
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "jm_financial"
        self.provider = "jm_financial"
        ...
        self.BASE_URL = "https://www.jmfl.com"
        self.logger = logging.getLogger("JMFinancialProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("jm_financial: BASE_URL=%s — not verified from live trace", self.BASE_URL)
