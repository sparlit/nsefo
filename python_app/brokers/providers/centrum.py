...
class CentrumProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "centrum"
        self.provider = "centrum"
        ...
        self.BASE_URL = "https://www.centrum.in"
        self.logger = logging.getLogger("CentrumProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("centrum: BASE_URL=%s — not verified from live trace", self.BASE_URL)
