...
class ShreeKrishnaProvider(Broker):
    DEPRECATED = False
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "shree_krishna"
        self.provider = "shree_krishna"
        ...
        self.BASE_URL = "https://www.shrikrishnashares.com"
        self.logger = logging.getLogger("ShreeKrishnaProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("shree_krishna: BASE_URL=%s — not verified from live trace", self.BASE_URL)
