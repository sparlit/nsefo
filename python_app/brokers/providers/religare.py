...
class ReligareProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "religare"
        self.provider = "religare"
        ...
        self.BASE_URL = "https://www.religareonline.com"
        self.logger = logging.getLogger("ReligareProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("religare: BASE_URL=%s — not verified from live trace", self.BASE_URL)
