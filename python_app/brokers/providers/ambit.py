...
class AmbitProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        self.BASE_URL = "https://www.ambit.co.in"
        self.logger = logging.getLogger("AmbitProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("ambit: BASE_URL=%s — not verified from live trace", self.BASE_URL)
