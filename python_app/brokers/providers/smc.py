...
class SMCProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        self.BASE_URL = "https://www.smconline.com"
        self.logger = logging.getLogger("SMCProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("smc: BASE_URL=%s — not verified from live trace", self.BASE_URL)
