...
class KediaProvider(Broker):
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        self.BASE_URL = "https://www.kediagroups.com"
        self.logger = logging.getLogger("KediaProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("kedia: BASE_URL=%s — not verified from live trace", self.BASE_URL)
