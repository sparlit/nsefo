# Migrated from python_app/broker/master_trust.py — DO NOT EDIT HERE
"""
Master Trust Broker Implementation
API Docs: https://mastersmart-api.mastertrust.co.in
Authentication: client_id + app_key + access_token
"""
...
BASE_URL = "https://mastersmart-api.mastertrust.co.in"


class MasterTrustProvider(Broker):
    def __init__(self, client_id: str, access_token: str, **kwargs):
        ...
        self.logger = logging.getLogger("MasterTrustProvider")
    ...
    def login(self, **kwargs) -> bool:
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                return True
            self.logger.warning(f"Master Trust login failed: {resp.status_code}")
            return False
        except Exception as e:
            self.logger.error(f"Master Trust Login Error: {e}")
            return False
    ...
    def start_data_feed(self, symbols: List[Dict[str, Any]],
        ...
        ws_url = "wss://streaming.mastertrust.co.in/stream"
