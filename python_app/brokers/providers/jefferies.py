...
class JefferiesProvider(Broker):
    DEPRECATED = False
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "jefferies"
        self.provider = "jefferies"
        ...
        self.BASE_URL = "https://www.jefferies.com"
        self.logger = logging.getLogger("JefferiesProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("jefferies: BASE_URL=%s — not verified from live trace", self.BASE_URL)
