...
class PhillipCapitalProvider(Broker):
    DEPRECATED = False
    ...
    def __init__(self, client_id: str = "", access_token: str = "", password: str = "",
        ...
        super().__init__()
        self._provider_key = "phillipcapital"
        self.provider = "phillipcapital"
        ...
        self.BASE_URL = "https://www.phillipcapital.in"
        self.logger = logging.getLogger("PhillipCapitalProvider")
    ...
    def login(self, **kwargs) -> bool:
        self.logger.warning("phillipcapital: BASE_URL=%s — not verified from live trace", self.BASE_URL)
